 ...
 * <p>
 * Polls a series of {@link org.acegisecurity.ui.logout.LogoutHandler}s. The handlers should be specified in the order they are required.
 ...
 *
 * @author Ben Alex
 * @version $Id: CustomLogoutFilter.java,v 1.1 2009-05-29 20:22:57 rodent1 Exp $
 */
...
//            HttpSession session = request.getSession(true);
             String logoutSuccessUrl2 = logoutSuccessUrl;
             String str = httpRequest.getSession().getAttribute("skin").toString();
             if ((str != null) && (str.equals("PRISM2"))) {
                logoutSuccessUrl2 += "?skin=PRISM2";
             }
             else {
                logoutSuccessUrl2 += "?skin=reset";
             }
            for (int i = 0; i < handlers.length; i++) {
                handlers[i].logout(httpRequest, httpResponse, auth);
            }
            sendRedirect(httpRequest, httpResponse, logoutSuccessUrl2);
