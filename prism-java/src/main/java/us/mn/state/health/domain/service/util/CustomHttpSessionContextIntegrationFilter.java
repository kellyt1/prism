 ...
 */
     ...
     *
     * @version $Id: CustomHttpSessionContextIntegrationFilter.java,v 1.1 2009-06-04 16:19:53 rodent1 Exp $
     */
    public class CustomHttpSessionContextIntegrationFilter implements InitializingBean, Filter {
        ...
        public CustomHttpSessionContextIntegrationFilter() throws ServletException {
        ...
        public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException,
            ...
            if (request.getParameter("skin") != null) {
                request.getSession().setAttribute("skin", request.getParameter("skin").equals("PRISM2") ? "PRISM2" : "reset");
            }

            if (request.getParameter("requestType") != null) {
                request.getSession().setAttribute("requestType", request.getParameter("requestType"));
            }
        ...
        private SecurityContext readSecurityContextFromSession(HttpSession httpSession) {
            ...
            if (cloneFromHttpSession) {
                ...
                try {
                    Method m = contextFromSessionObject.getClass().getMethod("clone");
                    if (!m.isAccessible()) {
