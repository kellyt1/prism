...
<html>
  <head>
    <title>Edit Sensitive Asset</title>
  </head>
  <body>
    <div align="center">
    <nested:form action="editSensitiveAsset.do" method="post">
        <input type="HIDDEN" name="cmd" />
        <table class="table" align="center" border="0" cellspacing="0" cellpadding="5" style="width:85%; background:#ccc;">
            <tr>
                <td colspan="4" align="center">Edit Sensitive Asset</td>
            </tr>
            <tr>
                <td>Description:</td>
                <td>Category:</td>
            ...
            <tr>
                <td><nested:write property="sensitiveAsset.item.description" /></td>
                <td><nested:write property="sensitiveAsset.item.category.name" /></td>
                <td>
                    <nested:present property="sensitiveAsset.item.manufacturer">
                        <nested:write property="sensitiveAsset.item.manufacturer.externalOrgDetail.orgName"/>
                    </nested:present>
                </td>
                <td><nested:write property="sensitiveAsset.item.model" /></td>
            </tr>
            <tr>
                <td></td>
                <td>Serial Nbr:</td>
                ...
                <td valign="top">
                    ...
                    <nested:iterate length="orgBudget" property="ownerOrgBudgets" indexId="a">                    
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td><a href='${pageContext.request.contextPath}/editSensitiveAsset.do?cmd=removeOwnerOrgBdgt&orgBdgtId=<nested:write property="orgBudgetId" />'>remove</a></td>
                        </tr>
                   </nested:iterate>
                   </table>
                    <br />
                    <nested:select property="orgBudgetId" style="width: 200px" styleClass="chosen-select">
                        <option value=""> </option>
