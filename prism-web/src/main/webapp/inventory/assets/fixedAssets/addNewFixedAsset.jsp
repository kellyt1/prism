...
<html>
  <head>
    <title>Add New Fixed Asset - Step 2</title>
  </head>
  <body>
    <div align="center">
    <nested:form action="addNewFixedAsset.do" method="post">
        <input type="HIDDEN" name="cmd" />
        <table class="table" align="center" border="0" cellspacing="0" cellpadding="5" style="width:85%; background:#ccc;">
            <tr>
                <td colspan="4" align="center" class="tableheader">Add New Fixed Asset</td>
            </tr>
            <tr>
                <td>Description:</td>
                <td>Category:</td>
            ...
            <tr>
                ...
                <td><nested:textarea property="notes"/></td>
            </tr>
            <tr>
