...
<html>
    ...
    <body>
        <html:form action="/saveOrderComputer" method="post">
                        ...
                        <td colspan="2">
                            <table>
                                <tr >
                                    ...
                                    <td><nested:text property="purchaseOrderNumber" size="20"/></td>
                                </tr>
                                <tr>
                                    <td colspan="2">&nbsp;</td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <label><nested:radio property="purchaseOrderNumberType" value="<%=Order.PO_NBR_TYPE_MAPS%>"/> SWIFT</label><br/>
                                        <label><nested:radio property="purchaseOrderNumberType" value="<%=Order.PO_NBR_TYPE_CREDIT%>"/> Credit</label><br/>
                                        <label><nested:radio property="purchaseOrderNumberType" value="<%=Order.PO_NBR_TYPE_NOCHARGE%>"/> No-Charge</label>
                                        <%--<label><nested:radio property="purchaseOrderNumberType" value="<%=Order.PO_NBR_TYPE_SWIFT%>"/> SWIFT Stock Item</label>--%>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td colspan="2">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><nested:text property="suspenseDate" size="10" styleClass="dateInput"/></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
            ...
            <table class="table table-bordered table-striped">
                ...
                <thead>
                    <tr>
                        <th>Note <button type="submit" onclick="this.form.action='addPurchaseOrderNoteComputer.do'" class="btn btn-default pull-right">Add Note</button></th>
                        <th>Author</th>
                        <th>Date</th>
                        ...
                        <nested:iterate id="orderLineItemForm" property="orderLineItemForms">
                            <nested:equal property="removed" value="false">
                                <tr>
                                    ...
                                    <td class="text-right">Vendor Information or PO#:</td>
                                    <td>
                                    ...
                                    <%--<td rowspan="2" class="text-center" style="vertical-align: middle;">--%>
                                        <%--<button type="SUBMIT" onclick="this.form.action='viewEditOrderLineItem.do';this.form.key.value='<nested:write property='key'/>'" class="btn btn-default">Edit</button>--%>
                                        <%--<nested:notEqual property="orderLineItem.status.statusCode" value="RCD">--%>
                                            <%--<nested:notEqual property="orderLineItem.status.statusCode" value="RCP">--%>
                                                <%--&nbsp;<button type="SUBMIT" onclick="this.form.action='removeOrderLineItem.do';this.form.key.value='<nested:write property='key'/>'" class="btn btn-default">Remove</button>--%>
                                            <%--</nested:notEqual>--%>
                                        <%--</nested:notEqual>--%>
                                    <%--</td>--%>
                                </tr>
        ...
        <nested:greaterThan property="reqLnItemFormCount" value="0">
                    ...
                    <tr>
                        ...
                        <th>
                            <htmlx:sortAnchor name="orderForm"
                                              ...
                                              input="/purchasing/orderComputer.jsp">Request<br /> Line #
                            </htmlx:sortAnchor>
                        </th>
                        <th>
                            <htmlx:sortAnchor name="orderForm"
                                              ...
                                              input="/purchasing/orderComputer.jsp">Description
                            </htmlx:sortAnchor>
                        </th>
                        <th nowrap>
                            <htmlx:sortAnchor name="orderForm"
                                              ...
                                              input="/purchasing/orderComputer.jsp">Suggested<br />Vendor or PO#
                            </htmlx:sortAnchor>
                        </th>
                        <th>
                            <htmlx:sortAnchor name="orderForm"
                                              style="color: inherit;"
                                              property="requestLineItemForms"
                                              value="requestLineItem.swiftId, requestLineItem.requestLineItemId"
                                              input="/purchasing/orderComputer.jsp">AC2 Code
                            </htmlx:sortAnchor>
                        </th>
                        <th>
                            <htmlx:sortAnchor name="orderForm"
                                              style="color: inherit;"
                                              property="requestLineItemForms"
                                              value="requestLineItem.fundingSrcSummary.fundingStrings, requestLineItem.requestLineItemId"
                                              input="/purchasing/orderComputer.jsp">
                        ...
                        <th>
                            <htmlx:sortAnchor name="orderForm"
                                              ...
                                              input="/purchasing/orderComputer.jsp">Status
                            </htmlx:sortAnchor>
                        </th>
                        <th>Deliver To</th>
                        <th>
                            <htmlx:sortAnchor name="orderForm"
                                              ...
                                              property="requestLineItemForms"
                                              value="requestLineItem.status.name, requestLineItem.requestLineItemId"
                                              input="/purchasing/orderComputer.jsp">Need By
                            </htmlx:sortAnchor>
                        </th>
                        <th></th>
                    </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <nested:equal property="requestLineItem.suggestedVendorCatalogNumber" value="MNITCONTRACT" >
                            <strong>MNIT Contract BB</strong><br/>
                        </nested:equal>
                        ...
                        <nested:equal property="requestLineItem.suggestedVendorCatalogNumber" value="WAN/Computing Services" >
                            <strong>MNIT WAN/Computing Services BB</strong><br/>
                        </nested:equal>


                        <i><nested:write property="requestLineItem.swiftId"/></i>
                    </td>
                    <td>
                    ...
                    <td class="text-center">
                        <button type="submit" onclick="this.form.action='viewEditPurchasingRequestFromOrder.do';this.form.requestLineItemId.value='<nested:write property='requestLineItem.requestLineItemId'/>'"
                                class="btn btn-default">Edit</button><br><br>
                        <button type="submit" onclick="this.form.action='removeRequestLineItemFromOrder.do';this.form.requestLineItemId.value='<nested:write property='requestLineItem.requestLineItemId'/>'"
            ...
            <div class="col-md-12 text-center">
                <nested:greaterThan property="reqLnItemFormCount" value="0">
                    <button type="submit" onclick="this.form.action='viewCreateOrderLineItemComputer.do'" class="btn btn-default">Add to New Order Line Item</button>&nbsp;
                </nested:greaterThan>
                <nested:greaterThan property="reqLnItemFormCount" value="0">
                    <nested:greaterThan property="orderLnItemFormCount" value="0">
                        <button type="submit" onclick="this.form.action='viewAddToOrderLineItemComputer.do'; this.form.cmd.value='addToOrderLineItem';" class="btn btn-default">Add to Selected Order Line Item</button>&nbsp;
                    </nested:greaterThan>
                </nested:greaterThan>
                &nbsp;
                <button type="submit" onclick="this.form.action='saveOrderComputer.do'" class="btn btn-default">Save MNIT Order</button>
                <logic:notEmpty name="orderForm" property="orderId">
                    &nbsp;
                    <button onclick="window.open('printPurchaseOrder.do?orderId=<nested:write property='orderId'/>&reportType=internalPO');return false;" class="btn btn-default">View Internal PO Report</button>
                </logic:notEmpty>
                <logic:notEmpty name="orderForm" property="purchaseOrderNumber">
                    &nbsp;
                    <button onclick="window.open('printPurchaseOrder.do?orderId=<nested:write property='orderId'/>&reportType=vendorPO');return false;" class="btn btn-default">View Vendor PO</button>
                </logic:notEmpty>
            </div>
        </html:form>
    </body>
