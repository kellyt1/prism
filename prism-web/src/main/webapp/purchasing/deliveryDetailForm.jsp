...
<html>
    ...
    <body>
        <nested:form action="/changeItemDefaultDeliveryDetails" method="post">
            <nested:hidden property="cmd" value="" />
            <nested:hidden property="itemId" value="${purchaseItemForm.itemId}"/>
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <fieldset class="text-center">
                        <legend>Deliver to</legend>
                            <label><html:radio name="purchaseItemForm" property="deliveryDetailForm.deliverToType" value="<%=DeliveryDetailForm.DELIVER_TO_MDH%>"  onchange="this.form.cmd.value='reload'; this.form.submit(); return false;"/> MDH Employee</label><br>
                            <label><html:radio name="purchaseItemForm" property="deliveryDetailForm.deliverToType" value="<%=DeliveryDetailForm.DELIVER_TO_CITIZEN%>" onchange="this.form.cmd.value='reload'; this.form.submit(); return false;" /> Private Citizen</label><br>
                            <label><html:radio name="purchaseItemForm" property="deliveryDetailForm.deliverToType" value="<%=DeliveryDetailForm.DELIVER_TO_EXT_ORG%>" onchange="this.form.cmd.value='reload'; this.form.submit(); return false;" /> External Organization</label>
                    </fieldset>
                </div>
            </div>
                <br><br>
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <table style="width: 100%;">
                            ...
                            <logic:equal name="purchaseItemForm" property="deliveryDetailForm.deliverToType" value="<%=DeliveryDetailForm.DELIVER_TO_CITIZEN%>">
                                <tr>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <nested:iterate name="purchaseItemForm" property="deliveryDetailForm.mailingAddresses" indexId="a" id="ddf" >
                                                    <tr>
                            ...
                            <logic:equal name="purchaseItemForm" property="deliveryDetailForm.deliverToType" value="<%=DeliveryDetailForm.DELIVER_TO_EXT_ORG%>">
                                <tr>
                            ...
                            <logic:equal name="purchaseItemForm" property="deliveryDetailForm.deliverToType" value="<%=DeliveryDetailForm.DELIVER_TO_MDH%>">
                                <tr>
