    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <nested:equal property="input" value="purchasingRequest">
                <button type="submit" onclick="this.form.action='viewCreatePurchasingRequestLineItem.do'" class="btn btn-default">Create New Request Line Item (Non-Catalog)</button>
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <div class="btn-group">
                ...
                <nested:notEmpty property="requestLineItemForm">
                    <button type="submit" onclick="this.form.action='savePurchasingRequestLineItem.do'" class="btn btn-default">Done With Request Line Item</button>
                </nested:notEmpty>
                <nested:notEqual property="input" value="purchasingRequest">
                    <button type="submit" onclick="this.form.action='cancelEditPurchasingRequest.do'" class="btn btn-default">Return Without Saving</button>
                </nested:notEqual>
            </div>
        </div>
    </div>
