    ...
    <body>
        <html:form action="/saveOrder" method="post">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <tr>
                                <td>
                                    <nested:select property="vendorId" onchange="this.form.action='chooseOrderVendor.do';this.form.submit(); return false;" styleClass="chosen-select">
                                        <option value=""></option>
                                    ...
                                    <label>
                                        ...
                                        <logic:notEmpty name="orderForm" property="vendor">
                                            <logic:notEmpty name="orderForm" property="vendorContracts">
                                                <nested:select property="vendorContractId" styleClass="chosen-select">
                                    ...
                                    <label>
                                        ...
                                        <logic:notEmpty name="orderForm" property="vendor">
                                            <logic:notEmpty name="orderForm" property="vendorAccounts">
                                                <nested:select property="vendorAccountId" styleClass="chosen-select">
                                ...
                                <td><label>Address:</label><br/>
                                    <logic:notEmpty name="orderForm" property="vendor">
                                        <logic:notEmpty name="orderForm" property="vendorAddresses">
                                            <nested:select property="vendorAddressId" styleClass="chosen-select">
                                                <option value=""></option>
                    ...
                    <tr>
                        ...
                        <td>
                            <nested:select property="billToAddressId" style="width:200px" styleClass="chosen-select">
                                <option value=""></option>
                        ...
                        <td>
                            <nested:textarea property="otherBillToAddress" cols="25" rows="4"/>
                        </td>
                        <td class="text-right"><label>Remit To:</label></td>
                        <td>
                            <nested:textarea property="remitToAddress" cols="25" rows="4"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="text-right"><label>Ship To:</label></td>
                        <td>
                            <nested:select property="shipToAddressId" style="width:200px" onchange="updateVendorInstructions(this.value)" styleClass="chosen-select">
                                <option value=""></option>
                        ...
                        <td>
                            <nested:textarea property="otherShipToAddress" cols="40" rows="2"/>
                        </td>
                        <td class="text-right"><label>Vendor<br>Instructions:</label></td>
                        <td colspan="3">
                        <span id="vendorInstructions2">
                            <nested:textarea property="vendorInstructions" cols="30" rows="2"/>
                         </span>
                        </td>
                    </tr>
                </table>
            ...
            <table class="table table-bordered table-striped">
                ...
                <thead>
                    <tr>
                        <th>Note <button type="submit" onclick="this.form.action='addPurchaseOrderNote.do'" class="btn btn-default pull-right">Add Note</button></th>
                        <th>Author</th>
                        <th>Date</th>
        ...
        <nested:greaterThan property="reqLnItemFormCount" value="0">
                    ...
                    <tr>
                        ...
                        <th>
                            <htmlx:sortAnchor name="orderForm"
                                              ...
                                              input="/purchasing/order.jsp">Request<br /> Line #
                            </htmlx:sortAnchor>
                        </th>
                        <th>
                            <htmlx:sortAnchor name="orderForm"
                                              ...
                                              input="/purchasing/order.jsp">Description
                            </htmlx:sortAnchor>
                        </th>
                        <th nowrap>
                            <htmlx:sortAnchor name="orderForm"
                                              ...
                                              input="/purchasing/order.jsp">Suggested<br />Vendor
                            </htmlx:sortAnchor>
                        </th>
                        <th>
                            <htmlx:sortAnchor name="orderForm"
                                              ...
                                              input="/purchasing/order.jsp">Vendor Catalog #
                            </htmlx:sortAnchor>
                        </th>
                        <th>
                            <htmlx:sortAnchor name="orderForm"
                        ...
                        <th>
                            <htmlx:sortAnchor name="orderForm"
                                              ...
                                              input="/purchasing/order.jsp">Status
                            </htmlx:sortAnchor>
                        </th>
                        <th>Deliver To</th>
                        <th>
                            <htmlx:sortAnchor name="orderForm"
                                              ...
                                              property="requestLineItemForms"
                                              value="requestLineItem.status.name, requestLineItem.requestLineItemId"
                                              input="/purchasing/order.jsp">Need By
                            </htmlx:sortAnchor>
                        </th>
                        <th></th>
                    </tr>
            ...
            <div class="col-md-12 text-center">
                ...
                <logic:notEmpty name="orderForm" property="orderId">
                    &nbsp;
                    <button onclick="window.open('printPurchaseOrder.do?orderId=<nested:write property='orderId'/>&reportType=internalPO')" class="btn btn-default">View Internal PO Report</button>
                </logic:notEmpty>
