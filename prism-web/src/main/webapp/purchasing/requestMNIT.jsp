...
<body>
<html:form action="/savePurchasingRequestMNIT" method="post">
            ...
            <nested:notEmpty property="requestLineItemForms">
                <label>
                    ...
                    <nested:select size="4" property="requestLineItemKey" styleClass="form-control"
                                   ondblclick="this.form.action='viewEditPurchasingRequestLineItemMNIT.do'; this.form.submit(); return false;">
            ...
            <div class="col-md-12">
                ...
                <table class="table">
                    ...
                    <tr>
                        <td nowrap="nowrap">
                            <label>
                                        PO Number <nested:text property="requestLineItemForm.suggestedVendorName" />
                            </label>
                        </td>
                        <td>
                            <label>
                                        Type of order <nested:text property="requestLineItemForm.suggestedVendorCatalogNumber" readonly="true"/>
                            </label>
                        </td>
                        <td>
                        </td>
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <div class="btn-group">
                ...
                <%--<nested:notEmpty property="requestLineItemForm">--%>
                    <%--<button type="submit" onclick="this.form.action='savePurchasingRequestLineItemMNIT.do'" class="btn btn-default">Done With Request Line Item</button>--%>
                <%--</nested:notEmpty>--%>
                <nested:notEqual property="input" value="purchasingRequest">
                    <button type="submit" onclick="this.form.action='cancelEditPurchasingRequestMNIT.do'" class="btn btn-default">Return Without Saving</button>
                </nested:notEqual>
            </div>
        </div>
    </div>
