...
<body>
<html:form action="/searchOrdersForPurchasing.do" method="post">
                    ...
                    <tr>
                        <td colspan="6" align="center">
                            <input type="submit" value="Search"
                                   onclick="this.form.action='searchOrdersForPurchasing.do';"/>&nbsp;
                                               <input type="BUTTON" value="Clear" onclick="clearForm();" />
                            <button onclick="this.form.action='/purchasing/index.jsp';this.form.submit(); return false;">
                                Cancel</button>
                        </td>
                    </tr>
                </table>
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <nested:greaterThan name="searchOrdersForm" property="firstResult"
                                                    value="0">
                                    <a href='searchOrdersForPurchasing.do?paginationDirection=<%=Form.PREVIOUS%>'>
                                        &lt; Prev</a> &nbsp;
                                </nested:greaterThan>
                                <nested:equal name="searchOrdersForm" property="displayNextLink"
                                              value="true">
                                    <a href="searchOrdersForPurchasing.do?paginationDirection=<%=Form.NEXT%>">Next
                                        &gt;</a>
                                </nested:equal>
                            </td>
                        </tr>
                            ...
                            <tr>
                                <td align="center">
                                    <input type="SUBMIT"
                                           ...
                                           onclick="this.form.action='viewEditOrder.do'; this.form.orderId.value='<nested:write property='orderId'/>'"/>
                                </td>
                                <td align="left">
