...
<head>
    ...
    <script type="text/javascript">
        function updateTotalCost() {
            ...
            document.getElementById("totalCost").innerHTML = (buyUnitCost * qty ).toFixed(2);
        }
    </script>
</head>
<body>
<html:form action="/saveOrderLineItemComputer.do" method="post">
            ...
            <div class="panel panel-body">
                <div class="row form-inline">
                    ...
                    <div class="form-group col-md-5">
                        ...
                        <nested:textarea styleClass="form-control" property="itemDescription" cols="40" rows="3"/>
                    </div>
                ...
                <div class="row form-inline">
                    <div class="form-group col-md-2">
                        ...
                        <nested:text styleClass="form-control" property="quantity" size="5" onkeyup="updateTotalCost();" onblur="updateTotalCost();"/>
                    </div>
                    <div class="col-md-4">
                        <div class="row">
                            <div class="form-group col-md-5">
                        ...
                        <nested:notEmpty property="item">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <nested:text styleClass="form-control" property="dispenseUnitsPerBuyUnit" size="10" value="1" onkeyup="updateTotalCost();" onblur="updateTotalCost();"/>
                                </div>
                            </div>
                        </nested:notEmpty>
                    </div>
                    ...
                    $<nested:text property="buyUnitCost" size="15" onblur="updateTotalCost();" onkeyup="updateTotalCost();" styleClass="blurOnLoad form-control"/>
                    </div>
                    <div class="form-group col-md-3">
            ...
            <table class="table table-bordered table-striped">
                ...
                <thead>
                    <tr>
                        ...
                        <th style="white-space: nowrap;">AC2 Code</th>
                    ...
                    <nested:iterate property="requestLineItemForms">
                        <nested:equal property="removedFromOrderLineItem" value="false">
                            <tr>
                                ...
                                <td><nested:write property="requestLineItem.swiftId"/></td>
                                ...
                                <td class="text-center">
                                    <button type="submit" onclick="this.form.action='viewEditPurchasingRequestFromOrderLineItemMNIT.do';this.form.requestLineItemId.value='<nested:write property='requestLineItem.requestLineItemId'/>'" class="btn btn-default">Edit</button>
        ...
        <script>
            $j(document).ready(function(){
                $j("#assetOptionsInfo").tooltip({content: $j(".assetOptions").html()});
            })
        </script>
    </body>
</html>