...
<html>
    ...
    <body>
        <html:form action="/saveRequestLineEdit" method="post">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6">
                                    <nested:select property="selectedRequestorId" styleClass="chosen-select" styleId="requestor" disabled="true">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6"><nested:text property="needByDate" size="10" styleClass="dateInput" styleId="neededBy" readonly="true"/></div>
                            </div>
                            <br/>
                            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table">
                            ...
                            <tr>
                                <td>
                                    <nested:equal property="requestLineItemForm.itPurchase" value="true">Category: <nested:text property="requestLineItemForm.categoryId" readonly="true"/></nested:equal>
                                    <nested:notEqual property="requestLineItemForm.itPurchase" value="true">
                                    <label>
                                        Category:
                                        <nested:empty property="requestLineItemForm.item">
                                            <nested:select property="requestLineItemForm.categoryId" styleClass="chosen-select" disabled="true">
                                ...
                                <td>
                                    <label>Quantity: <nested:text property="requestLineItemForm.quantity" size="10" readonly="true"/></label></td>
                                <td>
                                    <label>
                                        <nested:empty property="requestLineItemForm.item">
                                            Unit:
                                            <nested:select property="requestLineItemForm.unitId" styleClass="chosen-select" disabled="true">
                                ...
                                <td nowrap="nowrap">
                                    <label>
                                        <nested:empty property="requestLineItemForm.item">
                                            Cost/Unit: $<nested:text property="requestLineItemForm.itemCost" size="20" readonly="true"/>
                                        </nested:empty>
                                        <nested:notEmpty property="requestLineItemForm.item">
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <nested:present property="requestLineItemForm.swiftItemId">
                                                <label>AC2# - <nested:text property="requestLineItemForm.swiftItemId" readonly="true"/></label>
                                    </nested:present>
                                </td>
                            </tr>
                            </c:when>
                                ...
                                <tr>
                                    <td colspan="5">
                                        <label>
                                            ...
                                            <nested:select property="requestLineItemForm.fundingSourceForm.orgBudgetId" styleClass="chosen-select"  disabled="true">
                ...
                <div class="col-md-12 text-center">
                    <div class="btn-group">
                        <button type="submit" class="btn btn-default">Save Request</button>
                            <button type="submit" onclick="this.form.action='viewSearchPurchasingRequestLineItems2.do'" class="btn btn-default">Return Without Saving</button>
                    </div>
                </div>
            </div>
        </html:form>
