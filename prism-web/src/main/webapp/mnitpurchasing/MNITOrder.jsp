    ...
    <body>
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <tr>
                                <td>
                                    <nested:select property="vendorId" onchange="this.form.action='chooseOrderVendor.do';this.form.submit(); return false;" styleClass="chosen-select" disabled="true">
                                        <option value=""></option>
                    ...
                    <tr>
                        ...
                        <td>
                            <nested:select property="shipToAddressId" style="width:200px" onchange="updateVendorInstructions(this.value)" disabled="true" styleClass="chosen-select">
                                <option value=""></option>
                                ...
                                <td>
                                    <c:choose>
                                        <c:when test="${User.firstAndLastName == orderNoteForm.authorName}">
                                            ...
                                            <button type="submit" onclick="return removePurchaseOrderNote('<nested:write property='key'/>')" class="btn btn-default pull-right" disabled="true">Remove Note</button>
                                        </c:when>
                                        <c:otherwise>
                            ...
                            <nested:equal property="removed" value="false">
                                <tr>
                                    ...
                                    <td rowspan="2" class="text-center" style="vertical-align: middle;">
                                        <button type="SUBMIT" onclick="this.form.action='viewEditOrderLineItemMNIT.do';this.form.key.value='<nested:write property='key'/>'" class="btn btn-default">Edit</button>
                                    </td>
                                </tr>
                                <tr>
                                <logic:greaterThan name="orderForm" property="reqLnItemFormCount" value="0">
        ...
        <nested:greaterThan property="reqLnItemFormCount" value="0">
            ...
            <div class="col-md-12 text-center">
                ...
                &nbsp;
                <button type="submit" onclick="this.form.action='purchasing/searchOrdersForPurchasingMNIT.do'" class="btn btn-default">Close Order</button>
