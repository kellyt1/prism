...
<html>
    ...
    <body>
        <html:form action="/viewMaintainShoppingLists" method="post">
            <div class="row">
                <div class="col-md-12">
                    <fieldset>
                        <legend>My Shopping Lists</legend>
                        <nested:notEmpty property="shoppingLists">
                            ...
                            <nested:select property="shoppingListId" value="" styleClass="chosen-select" styleId="shoppingList"
                                           onchange="this.form.action='viewEditShoppingList.do';this.form.submit()" >
                ...
                <div class="col-md-12 text-center">
                    <div class="btn-group">
                        <nested:notEmpty property="shoppingListForm.shoppingListLineItemForms">
                            <button type="SUBMIT" onclick="this.form.action='removeSelectedShoppingListItems.do'" class="btn btn-default">Delete Selected Items</button>
                        ...
                        <nested:notEmpty property="shoppingListForm">
                            <button type="SUBMIT" onclick="this.form.action='saveShoppingList.do'" class="btn btn-default">Save Shopping List</button>
                            <nested:notEmpty property="shoppingListForm.shoppingListId">
                                <button type="SUBMIT" onclick="this.form.action='removeShoppingList.do'" class="btn btn-default">Remove Shopping List</button>
                            </nested:notEmpty>
