        ...
        <script type="text/javascript">
            ...
            function validateSwift() {
                if (swift == true && document.getElementById('swiftId').value == '') {
                    alert("AC2 Code/Account Number is a required field. Please enter a AC2 Code or Account Number.")
                    return false;
                } else {
                    return true;
                }
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <nested:equal value="WAN/Computing Services" property="suggestedVendorCatalogNumber">
                                                <font color="red" size="-2">Enter the Application/Project Name from the
                                                    Budget Builder. Indicate static or line item funding:
                                                    <nested:write property="budgetBuilderLink" filter="false"/>
                                                </font></label></th>
                                    ...
                                    <tbody>
                                        ...
                                        <%--<logic:notEqual name="skin" value="PRISM2">--%>
                                            ...
                                            <%--</tr>--%>
                                            <tr>
                                                <td colspan="2"><label>AC2 Code/Account Number: <nested:text property="swiftItemId" styleId="swiftId"/></label></td>
