    ...
    <head>
        ...
        <script type="text/javascript">
            function clearForm() {
                ...
                form.swiftItemId.value = "";
            }
        </script>
    </head>
    <body>
        <html:form action="/advancedSearchRequests" method="post">
            <fieldset>
                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td colspan="2"><label>SWIFT Item ID or AC2 Code: <nested:text property="swiftItemId"/></label></td>
                        <td colspan="1">&nbsp;</td>
                        <td>
                            <%--<script type="text/javascript">
                                $j('#requestor').val(<%=user.getPersonId()%>);
                            </script>--%>
                            <label>Requestor :
                                <nested:select property="requestorId" styleClass="chosen-select" styleId="requestor">
                                    <option value="">Any</option>
                ...
                <div class="col-md-12 text-center">
                    ...
                    <button onclick="this.form.action='/advancedSearchRequests.do';this.form.submit(); return false;" class="btn btn-default">Cancel</button>
                </div>
            </fieldset>
        </html:form><br>
        <nested:form action="advancedSearchRequests" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6 text-right">
                        <nested:greaterThan name="searchMaterialRequestsForm" property="firstResult" value="0">
                            <a href='advancedSearchRequests.do?paginationDirection=<%=Form.PREVIOUS%>'>&lt; Prev</a> &nbsp;
                        </nested:greaterThan>
                        &nbsp;<label>Page #:
                        <select>
                        ...
                        <nested:equal name="searchMaterialRequestsForm" property="displayNextLink" value="true">
                            <a href="advancedSearchRequests.do?paginationDirection=<%=Form.NEXT%>">Next &gt;</a>
                        </nested:equal>
                    </div>
                </div><br/>
                    ...
                    <nested:iterate id="materialsRequest" name="searchMaterialRequestsForm" property="requestForms" indexId="a">
                        <%
                            showDetails = "this.form.cmd.value='" + Command.HIDE_DETAIL
                                ...
                                + "this.form.action='/advancedSearchRequests.do#"+ a + "'; this.form.submit(); return false;";
                                    ...
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <nested:equal value="IT Services and Contracts"
                                                              property="category.name">
                                                    <th scope="col"> Category</th>
                                                </nested:equal>
                                                <nested:equal value="IT Staff"
                                                              property="category.name">
                                                    <th scope="col"> Category</th>
                                                </nested:equal>
                                                <nested:equal value="WAN"
                                                              property="category.name">
                                                    <th scope="col"> Category</th>
                                                </nested:equal>
                                            ...
                                            <tr>
                                                <td class="text-center">
                                                    <nested:equal property="showNotes" value="false">
                                                        <a href="${pageContext.request.contextPath}/advancedSearchRequests.do?requestFormIndex=<%=requestFormIndex%>&cmd=<%=Command.SHOW_NOTES%>&rliId=<nested:write property='requestLineItemId'/>#<bean:write name='a'/>">View Notes</a>
                                                    </nested:equal>
                                                    <nested:equal  property="showNotes" value="true">
                                                        <a href="${pageContext.request.contextPath}/advancedSearchRequests.do?requestFormIndex=<%=requestFormIndex%>&cmd=<%=Command.HIDE_NOTES%>&rliId=<nested:write property='requestLineItemId'/>#<bean:write name='a'/>">Hide Notes</a>
                                                    </nested:equal>
                                                </td>
                                                <td>
                                                    ...
                                                    <nested:notPresent property="item">
                                                        ...
                                                        <nested:notEmpty property="swiftItemId">
                                                            <c:choose>
                                                                <c:when test="${rliForm.suggestedVendorCatalogNumber == 'STAFFAUG' || rliForm.suggestedVendorCatalogNumber == 'MNITCONTRACT'|| rliForm.suggestedVendorCatalogNumber == 'WAN/Computing Services'}">
                                                                    <br/>AC2: <nested:write property="swiftItemId"/>
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <br>SWIFT Item ID# - <nested:write property="swiftItemId"/>
                                                                </c:otherwise>
                                                            </c:choose>
                                                ...
                                                <nested:equal property="category.name"
                                                              value="IT Services and Contracts">
                                                    <td>
                                                ...
                                                <td style="padding: 0;">
                                                    <table class="table">
                                                        ...
                                                        <nested:iterate property="fundingSourceForms" id="requestLineItemFundingSourceForm">
                                                            <tr>
                                                                <td>
                                                                    <nested:select property="orgBudgetId" disabled="true" styleClass="chosen-select" styleId="bdgt">
                                                                        <option value=""></option>
