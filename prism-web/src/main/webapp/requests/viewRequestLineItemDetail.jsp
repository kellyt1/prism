...
<br><br>
<html:errors/>
<nested:form action="/viewRequestLineItemDetail" method="post">
...
<% int i = 0; %>
<tr><th><nested:write property="trackingNumber"/></th></tr>
<tr>
    <td></td>
    <%--<td class="tableshade" align="center">Item Description</td>--%>
    <%--<td class="tableshade" align="center">Item Type</td>--%>
    <%--<td class="tableshade" align="center">Quantity</td>--%>
    <%--<td class="tableshade" align="center">Unit</td>--%>
    <%--<td class="tableshade" align="center">Unit Cost</td>--%>
    <%--<td class="tableshade" align="center">Estimated Cost</td>--%>
    <%--<td class="tableshade" align="center">Status</td>--%>
    <%--<td class="tableshade" align="center">Funding Sources</td>--%>
</tr>
<nested:iterate id="rliForm" property="requestLineItemForms">
<tr>
<td class="tableshade" align="center">Notes</td>    
<td class="tabledetail" align="center" valign="top" colspan="1">
    <nested:equal property="showNotes" value="false">
        <a href="${pageContext.request.contextPath}/viewMyRequests.do?requestFormIndex=<%=requestFormIndex%>&cmd=<%=Command.SHOW_NOTES%>&rliId=<nested:write property='requestLineItemId'/>">View
            Notes</a>
    </nested:equal>
    <nested:equal property="showNotes" value="true">
        <a href="${pageContext.request.contextPath}/viewMyRequests.do?requestFormIndex=<%=requestFormIndex%>&cmd=<%=Command.HIDE_NOTES%>&rliId=<nested:write property='requestLineItemId'/>">Hide
            Notes</a>
    </nested:equal>
</td>
<td class="tableshade" align="center">Item Description</td>    
...
<nested:write property="itemDescription"/>
    ...
    <nested:equal value="<%=Status.WAITING_FOR_APPROVAL%>" property="statusCode">
        <br/>
        <a href=""
           onclick="window.open('/viewApprovalStatus?requestLineItemId=<nested:write property='requestLineItemId'/>&trackingNumber=<nested:write property="request.trackingNumber"/>&showIndicator=true', '','toolbar=no, directories=no, location=no, status=no, menubar=no, resizable=yes, scrollbars=yes, HEIGHT=600, WIDTH=600, left=50, top=50'); return false;">
            <span style="color:blue;">(Current Approval Status)</span>
        </a><br/>
    </nested:equal>
    </c:if>
</td>
        ...
        <td colspan="4">
            <table border="0" cellspacing="0">
                <tr>
                    <td class="tabledetail">
                        <table cellspacing="0" border="0" cellpadding="2" id="fundingSourcesTable_NonCatItem">
                            ...
                            <nested:iterate property="fundingSourceForms" id="requestLineItemFundingSourceForm">
                                <tr>
                                    <td align="center">
                                        <nested:select disabled="true" property="orgBudgetId" style="width:600px">
                                            <option value=""></option>
                                            <nested:optionsCollection property="orgBudgets"
                    ...
                    <td nowrap="nowrap" class="tabledetail">
                         <nested:radio property="amountInDollars" value="true"/>dollars<br>
                         <nested:radio property="amountInDollars" value="false"/>percent
                    </td>
                </tr>
                <!--
                                              <tr bgcolor="#cccccc">
...
<tr><td colspan="8"><hr width="100%"/> </td>
<%}%>
</tr>
<nested:equal property="showNotes" value="true">
    <tr>
