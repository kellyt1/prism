...
<html>
    ...
    <body>
        <display:table export="false" name="requestScope.requestLineItemsOnOrder" class="displaytag" id="parent">
            <display:column title="MRQ#" property="request.trackingNumber"/>
            <display:column title="Date Requested" property="request.dateRequested" format="{0,date,MM/dd/yyyy}"/>
