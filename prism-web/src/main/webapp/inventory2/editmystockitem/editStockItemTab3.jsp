        ...
        <div>
            <ul class="nav nav-tabs" role="tablist">
                <li><a href="javascript:void(0);"
                       onclick="submitParameter('editStockItemForm',0,'/inventory/editMyStockItem.do','nextPage',0);">General
                    Info</a></li>
                            ...
                            <li>
                                <a href="javascript:void(0);"
                                   onclick="return OLgetAJAX('/inventory/getStockItemQtyAdjustmentHistory.do?stockItemId=<nested:write property='stockItem.itemId'/>&icnbr=<nested:write property="stockItem.fullIcnbr"/>',
                                                         displayStockQtyAdjustmentHistory, 300, 'ovfl1');">Stock
                                    Quantity Adjustment History</a>
