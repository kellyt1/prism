...
public class StockItemHitSafetyStockEmailBuilder implements EmailBuilder {
    public static Log log = LogFactory.getLog(StockItemHitSafetyStockEmailBuilder.class);
    private StockItem stockItem;
    private EmailBean emailBean;

    public static final String subject = "Stock Item is at safety stock level";
    ...
    public static final String safetyStockHeader = "<th width='10%'><u><b>Safety Stock:</b></u></th>";
    ...
    public StockItemHitSafetyStockEmailBuilder(StockItem stockItem, EmailBean emailBean) {
    ...
    public void buildMessage() {
        ...
        message.append(safetyStockHeader);
        ...
        message.append("<td align='center'>").append(stockItem.getSafetyStock()).append("</td>");
        ...
        message.append("<p>Please verify the physical quantity of this item. If the actual " +
                       ...
                       "the value in PRISM.  If the stock item's quantity is indeed at the " +
                       "Safety point, please notify the stock item's contacts so they can decide " +
...
//                to.append(Utility.createEmailAddress(person));
                to.append(person.getEmailAddressPrimary());//person.getNdsUserId()+"@health.state.mn.us,");
            }
        }
        catch(Exception e) {
