...
public class FixedAssetNewEmailBuilder implements EmailBuilder {
    public static final String request_message = "<br><br> A new fixed asset has been put into the system.";
    ...
    public static final String orderLineItemSubject = "New Fixed Asset PO#:";

    private OrderLineItem oli;
    private EmailBean emailBean;
    private DAOFactory factory;

    public FixedAssetNewEmailBuilder(OrderLineItem oli, EmailBean emailBean, DAOFactory factory) {
        this.oli = oli;
